function mostrarAlerta() {
    ...
    alerta.innerText = "¡Se ha subscrito correctamente!";
...
function Carrito2() {
    ...
    // Crear la alerta
    let alerta = document.createElement("div");
    alerta.innerText = "¡Se ha quitado correctamente!";
    alerta.style.position = "fixed";
    alerta.style.bottom = "10px";
    alerta.style.right = "10px";
    alerta.style.padding = "10px";
...
function toggleWishlist(productId) {
    let regular = document.querySelector(`.wishlist[data-product-id="${productId}"]:not([style*="display: none"])`);
    let solid = document.querySelector(`.wishlist[data-product-id="${productId}"][style*="display: none"]`);
    if (regular && solid) {
