...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="../Caballero/caballero.html">Tienda</a></li>
            <li><a href="../Caballero/caballero.html">Ofertas</a></li>
        </ul>

        <!--  Íconos  -->
        <div class="icons">
            <a href="../Inicio_de_sesion/Inicio.php"><i class="fa fa-user"></i></a> <!-- Perfil -->
            <a href="../Carrito.html"><i class="fa fa-shopping-cart"></i></a> <!-- Carrito -->
            <a href="../Wishlist.html"><i class="fa fa-heart"></i></a> <!-- Wish list -->
            <a href="./Idiomas_Region/Idiomas.html"><i class="fa fa-globe"></i></a> <!-- Idiomas -->
            <a href="#"><i class="fa fa-universal-access"></i></a> <!-- Accesibilidad -->
    ...
    <div class="product-container" data-product-id="1">
        <div class="product-card">
            ...
            <div class="actions">
                <button class="add-to-cart" onclick="Carrito()">Agregar al Carrito</button>
        ...
        <div class="product-card" data-product-id="2">
            ...
            <div class="actions">
                <button class="add-to-cart" onclick="Carrito()">Agregar al Carrito</button>
                <span class="wishlist" data-product-id="2" id="wishlist-regular" onclick="toggleWishlist(2); Carrito();"><i class="fa-regular fa-heart"></i></span>
                  <span class="wishlist" data-product-id="2" id="wishlist-solid" style="display: none;" onclick="toggleWishlist(2); Carrito2();"><i class="fa-solid fa-heart"></i></span>
          </div>
        </div>
        ...
        <div class="product-card" data-product-id="3">
            ...
            <div class="actions">
                <button class="add-to-cart" onclick="Carrito()">Agregar al Carrito</button>
                <span class="wishlist" data-product-id="3" id="wishlist-regular" onclick="toggleWishlist(3); Carrito();"><i class="fa-regular fa-heart"></i></span>
                  <span class="wishlist" data-product-id="3" id="wishlist-solid" style="display: none;" onclick="toggleWishlist(3); Carrito2();"><i class="fa-solid fa-heart"></i></span>
          </div>
        </div>
        ...
        <div class="product-card" data-product-id="4">
            ...
            <div class="actions">
                <button class="add-to-cart" onclick="Carrito()">Agregar al Carrito</button>
                <span class="wishlist" data-product-id="4" id="wishlist-regular" onclick="toggleWishlist(4); Carrito();"><i class="fa-regular fa-heart"></i></span>
                  <span class="wishlist" data-product-id="4" id="wishlist-solid" style="display: none;" onclick="toggleWishlist(4); Carrito2();"><i class="fa-solid fa-heart"></i></span>
          </div>
        </div>
        ...
        <div class="product-card" data-product-id="5">
            ...
            <div class="actions">
                <button class="add-to-cart" onclick="Carrito()">Agregar al Carrito</button>
                <span class="wishlist" data-product-id="5" id="wishlist-regular" onclick="toggleWishlist(5); Carrito();"><i class="fa-regular fa-heart"></i></span>
                  <span class="wishlist" data-product-id="5" id="wishlist-solid" style="display: none;" onclick="toggleWishlist(5); Carrito2();"><i class="fa-solid fa-heart"></i></span>
          </div>
        </div>
